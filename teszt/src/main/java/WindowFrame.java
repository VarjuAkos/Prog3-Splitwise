...
public class WindowFrame extends JFrame {
    ...
    private final JTextField expenseName;
    private final JTextField expenseValue;
    private final JComboBox PparticipantBox,EXPparticipantBox;
    private final JComboBox expenseBox;
    private final JComboBox transactionBox;
